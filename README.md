...
To optimize views/pizza.html, you will need to modify views/js/main.js until
your frames per second rate is 60 fps or higher. You will find instructive
comments in main.js.
...
arbitrary number
* changed documentQuery calls inside pizza resize loops to static variable calls to
